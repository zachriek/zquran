...
class DataStoreManager @Inject constructor (
    ...
    suspend fun saveProfileImage(profileImage: String) {
        context.dataStore.edit { preferences -> preferences[KEY_PROFILE_IMAGE] = profileImage }
    }

    suspend fun loadProfileImage(): Flow<String?> {
        return context.dataStore.data.map { preferences -> preferences[KEY_PROFILE_IMAGE] }
    }
}